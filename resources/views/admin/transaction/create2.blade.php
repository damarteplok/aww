...
<div class="card">
	...
	<div class="card-body">
		<form action="{{ route('transactions.store2') }}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<select name="category_id_d" id="category" class="form-control">

				  	@foreach($debits as $d)
				  
				  	<option value="{{ $d->id }}">D-{{ $d->name }}</option>
				  	@endforeach
				</select>
			</div>
